...
export const CartIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c.51 0 .962-.328 1.103-.816l1.72-4.901A1.125 1.125 0 0 0 18.25 6H5.23" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-8 h-8'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3H12m2.25 2.25H15M3.75 21.75c0-2.485 2.015-4.5 4.5-4.5H16.5c2.485 0 4.5 2.015 4.5 4.5V21.75H3.75Z" />
    </svg>
);

export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-8 h-8'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.586 9.094 9.094 0 0 0-3.742-.586m-4.5 0a9.094 9.094 0 0 0-3.742.586m3.742-.586a9.094 9.094 0 0 1-3.742.586m0 0a9.094 9.094 0 0 1-3.742-.586m3.742.586 4.5-10.636 4.5 10.636m-9-10.636L9 3.75l-4.5 10.636m18 0a9.094 9.094 0 0 0-3.742-.586m3.742.586a9.094 9.094 0 0 1-3.742-.586" />
    </svg>
);
...
export const ThumbsUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || 'w-6 h-6'}>
      <path d="M7.493 18.75c-.425 0-.82-.236-.975-.632A7.48 7.48 0 016 15.375c0-1.75.5-3.375 1.375-4.75A7.48 7.48 0 015.25 6H6c.414 0 .75-.336.75-.75S6.414 4.5 6 4.5H4.125c-.414 0-.75.336-.75.75V15c0 .414.336.75.75.75h.75c.414 0 .75-.336.75-.75s-.336-.75-.75-.75H4.5v-8.25h1.125c.249 0 .488.04.714.114 1.562.502 2.53 2.063 2.53 3.636 0 1.396-.713 2.63-1.786 3.321.252.34.532.654.838.941.22.205.448.4.68.585a7.48 7.48 0 012.429 2.063c.313.42.22.99-.2 1.304-.42.313-1.007.22-1.305-.2A4.49 4.49 0 009 15.75c-.69 0-1.35.28-1.843.75-.494.47-1.1.75-1.664.75z" />
      <path d="M12.98 4.5c.35 0 .686.124.942.35l2.458 2.458a.75.75 0 00.98-.98l-2.457-2.458A2.25 2.25 0 0012.98 3c-2.224 0-4.205 1.52-4.88 3.633a10.43 10.43 0 00-1.294 4.032 10.43 10.43 0 00.161 3.992.75.75 0 00.866.62c.42-.095.688-.506.592-.926a8.933 8.933 0 01-.138-3.461 8.933 8.933 0 011.107-3.463c.538-1.82 2.202-3.125 4.04-3.125z" />
    </svg>
);
  
export const ThumbsUpIconOutline: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904M6.633 10.5v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 00-1.125 1.125v7.5a1.125 1.125 0 001.125 1.125h1.5A3.375 3.375 0 006.633 10.5z" />
    </svg>
);

export const HahaIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || 'w-6 h-6'}>
      <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM8.26 8.87a.75.75 0 00-1.062 1.06l1.06-1.06zM15.74 8.87a.75.75 0 10-1.06-1.06l1.06 1.06zm-3.78 6.47a.75.75 0 01-1.06 0 5.25 5.25 0 00-7.425 0 .75.75 0 01-1.06-1.06 6.75 6.75 0 019.545 0 .75.75 0 01-1.06 1.06zM7.2 9.93a.75.75 0 001.06-1.061A2.25 2.25 0 0110.5 7.5a2.25 2.25 0 012.25 2.25.75.75 0 001.5 0A3.75 3.75 0 0010.5 6a3.75 3.75 0 00-3.535 2.607.75.75 0 00.235 1.323zM16.8 9.93a.75.75 0 001.06-1.061A3.75 3.75 0 0014.25 6a3.75 3.75 0 00-3.536 2.607.75.75 0 00.838 1.189 2.25 2.25 0 012.248-1.296 2.25 2.25 0 012.25 2.25.75.75 0 101.5 0 3.75 3.75 0 00-1.75-3.28z" clipRule="evenodd" />
    </svg>
);
  
export const WowIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || 'w-6 h-6'}>
      <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM9 8.25a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H9zm6.75 1.5a.75.75 0 000-1.5h-.008a.75.75 0 000 1.5h.008zM9 12.75a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5a.75.75 0 01-.75-.75z" clipRule="evenodd" />
    </svg>
);

export const ChatBubbleOvalLeftEllipsisIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.76v-2.52c0-.98.79-1.77 1.77-1.77h2.384a2.25 2.25 0 0 1 2.25 2.25v2.25a2.25 2.25 0 0 0 2.25 2.25h2.384a2.25 2.25 0 0 1 2.25 2.25v2.25a2.25 2.25 0 0 1-2.25-2.25H8.625a2.25 2.25 0 0 1-2.25-2.25v-2.25a2.25 2.25 0 0 0-2.25-2.25H3.75a2.25 2.25 0 0 1-2.25-2.25Zm13.5-9.01v-1.125c0-.98-.79-1.77-1.77-1.77h-2.384a2.25 2.25 0 0 0-2.25 2.25v2.25a2.25 2.25 0 0 1-2.25 2.25H5.025a2.25 2.25 0 0 0-2.25 2.25v2.25a2.25 2.25 0 0 0 2.25 2.25h2.384a2.25 2.25 0 0 1 2.25 2.25v2.25a2.25 2.25 0 0 1-2.25 2.25H8.625a2.25 2.25 0 0 1-2.25-2.25v-2.25a2.25 2.25 0 0 0-2.25-2.25H3.75a2.25 2.25 0 0 1-2.25-2.25Z" />
  </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.534a.75.75 0 01-.806-.748l.002-.102c.032-.383.223-.75.495-1.007l3.243-2.682a.75.75 0 00-.364-1.318l-3.243-.91a.75.75 0 01-.617-.912l.325-1.48a.75.75 0 01.912-.617l3.243.91a.75.75 0 00.932-.364l1.623-2.822a.75.75 0 01.968-.291zm-15 0c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.534a.75.75 0 01-.806-.748l.002-.102c.032-.383.223-.75.495-1.007l3.243-2.682a.75.75 0 00-.364-1.318l-3.243-.91a.75.75 0 01-.617-.912l.325-1.48a.75.75 0 01.912-.617l3.243.91a.75.75 0 00.932-.364l1.623-2.822a.75.75 0 01.968-.291z" />
    </svg>
);

// Fix: Add ChartBarIcon for use in dashboard pages.
...
export const PaperClipIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m18.375 12.739-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941-7.81 7.81a1.5 1.5 0 002.122 2.122l7.81-7.81" />
    </svg>
);

export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.742-.586 9.094 9.094 0 00-3.742-.586m-4.5 0a9.094 9.094 0 00-3.742.586m3.742-.586a9.094 9.094 0 01-3.742.586m0 0a9.094 9.094 0 01-3.742-.586m3.742.586 4.5-10.636 4.5 10.636m-9-10.636L9 3.75l-4.5 10.636m18 0a9.094 9.094 0 00-3.742-.586m3.742.586a9.094 9.094 0 01-3.742-.586" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.716.51 1.003l.884.884c.25.25.61.384.97.384h1.281c.55 0 .94.56.94 1.11v2.594c0 .36.134.72.384.97l.884.884c.25.287.447.629.51 1.003l.213 1.282c.09.541-.39.99-.94.99h-1.281c-.36 0-.72.134-.97.384l-.884.884c-.287.25-.629.447-1.003.51l-1.282.213c-.541.09-.99-.39-.99-.94v-2.594c0-.36-.134-.72-.384.97l-.884-.884c-.25-.287-.447-.629-.51-1.003l-.213-1.282c-.09-.541.39-.99.94-.99h1.281c.36 0 .72-.134.97-.384l.884.884c.287-.25.629-.447 1.003-.51l1.282-.213zM15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
    </svg>
);
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l15.482 0m-15.482 0a25.282 25.282 0 01-1.058 4.465l-2.32 2.32a2.121 2.121 0 01-3 0l-1.414-1.414a2.121 2.121 0 010-3l2.32-2.32A25.282 25.282 0 014.26 10.147z" />
    </svg>
);
...
export const PaintBrushIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.385m5.043.025a2.25 2.25 0 00-2.4 2.245 3 3 0 005.78-1.128 4.5 4.5 0 00-8.4 2.245c0 .399.078.78.22 1.128zm0 0l-3.18-3.18m5.043-3.386a7.5 7.5 0 00-10.607 10.607 15.99 15.99 0 0110.607-10.607z" />
    </svg>
);
...
export const ArrowTrendingUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.28m5.94 2.28L21 18M12 3.75h.008v.008H12V3.75Z" />
    </svg>
);
...
export const ThumbtackIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || 'w-6 h-6'}>
      <path d="M16.53 9.75A.75.75 0 0015 9H9a.75.75 0 000 1.5h6a.75.75 0 00.53-.22l3.22-3.22a.75.75 0 00-1.06-1.06L16.53 9.75z" />
      <path fillRule="evenodd" d="M13.635 2.582a.75.75 0 01.53.044l4.5 2.25a.75.75 0 01-.53 1.396l-3.32-.83v5.41l3.52 3.52a.75.75 0 01-1.06 1.06l-4.5-4.5a.75.75 0 010-1.06l4.5-4.5a.75.75 0 011.06 1.06L14.25 10.8V5.39l-2.22.555a.75.75 0 01-.97-1.125l2.585-3.23zM9.75 12a.75.75 0 01.75-.75h1.5a.75.75 0 01.75.75v9a.75.75 0 01-1.5 0v-9a.75.75 0 01-.75-.75z" clipRule="evenodd" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-4.991-2.691V5.25a2.25 2.25 0 00-2.25-2.25h-4.5a2.25 2.25 0 00-2.25 2.25v4.992m2.25 0l3.181-3.183a8.25 8.25 0 0111.664 0l3.181 3.183" />
    </svg>
);