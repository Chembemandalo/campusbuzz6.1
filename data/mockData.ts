...
export const mockNotifications: Notification[] = [
    { id: 'n1', text: 'Alice Johnson commented on your post.', isRead: false, timestamp: '15 mins ago', type: 'comment', linkId: 'p1', fromUser: mockUsers[2] },
    { id: 'n2', text: 'A new event "Tech Conference 2024" has been announced.', isRead: false, timestamp: '1 hour ago', type: 'event', linkId: 'e1' },
    { id: 'n3', text: 'Robert Brown sent you a friend request.', isRead: true, timestamp: '3 hours ago', type: 'friend_request', fromUser: mockUsers[3] },
    { id: 'n4', text: 'Your listing for "Used Calculus Textbook" has been sold.', isRead: true, timestamp: '1 day ago', type: 'listing' },
];
