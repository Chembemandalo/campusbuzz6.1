...
const App: React.FC = () => {
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case 'events': return <EventsPage events={events} currentUser={currentUser!} allUsers={users} onRsvp={handleRsvp} onOpenCreateEventModal={() => setCreateEventModalOpen(true)} handleBack={handleBack} />;
  ...
  return (
    <div className={`theme-${theme} font-sans flex flex-col min-h-screen`}>
        ...
        {currentUser && (
          <>
            <EventModal isOpen={isEventModalOpen} event={viewingEvent} currentUser={currentUser} allUsers={users} onClose={() => setEventModalOpen(false)} onRsvp={handleRsvp} />
